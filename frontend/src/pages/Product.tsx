          ...
          {!!id && productData && _.isEmpty(allProducts) ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="flex">
                ...
                <div>
                  <img src={imgUrl} alt="mainImage" className="w-full" />
                </div>
              </div>
              <div className="flex flex-col gap-4">
                ...
                <p className="flex items-center gap-2">
                  <FaRegEye />
                  <span>
                    {productData?.reviews} people are viewing this right now.
                  </span>
                </p>
                <p>
                  You are saving{" "}
                ...
                <AddToCartBtn
                  product={productData}
                  title="buy now"
                  className="bg-darkText/75 text-whiteText"
                />
                <div className="bg-[#f7f7f7] py-5 rounded-md flex flex-col items-center">
                  <img src={productPayment} alt="products payment" />
